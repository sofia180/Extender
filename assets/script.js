...
(() => {
  ...
  const translations = {
    ru: {
      ...
      "nav.pricing": "Цены",
      "title.pricing": "Extender | Цены",
      "pricing.hero.eyebrow": "Цены",
      "pricing.hero.title": "Прозрачные цены на все направления исполнения.",
      "pricing.hero.subtitle":
        "Выберите нужную услугу — запустим выделенную команду в течение нескольких дней. В каждом запросе включены лидерство, управление и еженедельная отчётность.",
      "pricing.hero.note":
        "Все цены в USD и указаны за базовую ежемесячную доставку, если не сказано иначе. Медиа‑бюджеты, сторонние лицензии и выездная работа оплачиваются отдельно.",
      "pricing.hero.talent": "Также можем помочь с поиском лучших специалистов под вашу программу.",
      "pricing.lead.price": "От $6k / месяц",
      "pricing.lead.range": "Обычно $8k - $15k",
      "pricing.marketing.price": "От $9k / месяц",
      "pricing.marketing.range": "Обычно $12k - $25k",
      "pricing.design.price": "От $5k / месяц",
      "pricing.design.range": "Обычно $8k - $18k",
      "pricing.automation.price": "От $10k / месяц",
      "pricing.automation.range": "Обычно $15k - $35k",
      "pricing.audit.price": "От $7k / аудит",
      "pricing.audit.range": "Обычно $10k - $25k",
      "pricing.security.price": "От $12k / месяц",
      "pricing.security.range": "Обычно $20k - $45k",
      "pricing.cloud.price": "От $15k / месяц",
      "pricing.cloud.range": "Обычно $25k - $60k",
      "pricing.enterprise.title": "Enterprise и тендеры",
      "pricing.enterprise.text":
        "Управление тендерными ответами, поддержка закупок и операционные bid‑процессы.",
      "pricing.enterprise.price": "От $12k / месяц",
      "pricing.enterprise.range": "Обычно $18k - $40k",
      "pricing.blockchain.price": "От $18k / проверка",
      "pricing.blockchain.range": "Обычно $25k - $60k",
      "pricing.gambling.title": "Азартные игры / ставки",
      "pricing.gambling.text":
        "Операции регулируемого gaming, контроль рисков и комплаенс‑доставка.",
      "pricing.gambling.price": "От $14k / месяц",
      "pricing.gambling.range": "Обычно $22k - $50k",
      "pricing.legal.price": "От $9k / месяц",
      "pricing.legal.range": "Обычно $15k - $30k",
      "pricing.cta.eyebrow": "Индивидуальный объём",
      "pricing.cta.title": "Нужен кастомный объём или мультисервисная программа?",
      "pricing.cta.subtitle":
        "Опишите задачи — мы сформируем команду исполнения в течение 48 часов.",
    ...
    uk: {
      ...
      "nav.pricing": "Ціни",
      "title.pricing": "Extender | Ціни",
      "pricing.hero.eyebrow": "Ціни",
      "pricing.hero.title": "Прозорі ціни на всі напрями виконання.",
      "pricing.hero.subtitle":
        "Обери потрібну послугу — запустимо виділену команду протягом кількох днів. У кожному запиті включені лідерство, управління та щотижнева звітність.",
      "pricing.hero.note":
        "Усі ціни в USD і вказані за базову щомісячну доставку, якщо не зазначено інше. Медіабюджети, сторонні ліцензії та виїзна робота оплачуються окремо.",
      "pricing.hero.talent": "Також можемо допомогти з пошуком найкращих спеціалістів під вашу програму.",
      "pricing.lead.price": "Від $6k / місяць",
      "pricing.lead.range": "Зазвичай $8k - $15k",
      "pricing.marketing.price": "Від $9k / місяць",
      "pricing.marketing.range": "Зазвичай $12k - $25k",
      "pricing.design.price": "Від $5k / місяць",
      "pricing.design.range": "Зазвичай $8k - $18k",
      "pricing.automation.price": "Від $10k / місяць",
      "pricing.automation.range": "Зазвичай $15k - $35k",
      "pricing.audit.price": "Від $7k / аудит",
      "pricing.audit.range": "Зазвичай $10k - $25k",
      "pricing.security.price": "Від $12k / місяць",
      "pricing.security.range": "Зазвичай $20k - $45k",
      "pricing.cloud.price": "Від $15k / місяць",
      "pricing.cloud.range": "Зазвичай $25k - $60k",
      "pricing.enterprise.title": "Enterprise та тендери",
      "pricing.enterprise.text":
        "Керування тендерними відповідями, підтримка закупівель та операційні bid‑процеси.",
      "pricing.enterprise.price": "Від $12k / місяць",
      "pricing.enterprise.range": "Зазвичай $18k - $40k",
      "pricing.blockchain.price": "Від $18k / перевірка",
      "pricing.blockchain.range": "Зазвичай $25k - $60k",
      "pricing.gambling.title": "Азартні ігри / ставки",
      "pricing.gambling.text":
        "Операції регульованого gaming, контроль ризиків та комплаєнс‑доставка.",
      "pricing.gambling.price": "Від $14k / місяць",
      "pricing.gambling.range": "Зазвичай $22k - $50k",
      "pricing.legal.price": "Від $9k / місяць",
      "pricing.legal.range": "Зазвичай $15k - $30k",
      "pricing.cta.eyebrow": "Індивідуальний обсяг",
      "pricing.cta.title": "Потрібен кастомний обсяг або мультисервісна програма?",
      "pricing.cta.subtitle":
        "Опишіть задачі — ми сформуємо команду виконання протягом 48 годин.",
    ...
    zh: {
      ...
      "nav.pricing": "价格",
      "title.pricing": "Extender | 价格",
      "pricing.hero.eyebrow": "价格",
      "pricing.hero.title": "覆盖全部执行能力的透明定价。",
      "pricing.hero.subtitle":
        "选择所需服务，我们将在几天内组建专属团队。每份报价都包含领导力、交付治理与每周汇报。",
      "pricing.hero.note":
        "所有价格以美元计，除非另有说明均为基础月度交付。媒体投放、第三方许可和现场工作另行计费。",
      "pricing.hero.talent": "我们还可以协助为你的项目寻找最优秀的专家。",
      "pricing.lead.price": "起价 $6k / 月",
      "pricing.lead.range": "常见区间 $8k - $15k",
      "pricing.marketing.price": "起价 $9k / 月",
      "pricing.marketing.range": "常见区间 $12k - $25k",
      "pricing.design.price": "起价 $5k / 月",
      "pricing.design.range": "常见区间 $8k - $18k",
      "pricing.automation.price": "起价 $10k / 月",
      "pricing.automation.range": "常见区间 $15k - $35k",
      "pricing.audit.price": "起价 $7k / 审计",
      "pricing.audit.range": "常见区间 $10k - $25k",
      "pricing.security.price": "起价 $12k / 月",
      "pricing.security.range": "常见区间 $20k - $45k",
      "pricing.cloud.price": "起价 $15k / 月",
      "pricing.cloud.range": "常见区间 $25k - $60k",
      "pricing.enterprise.title": "企业级与招投标",
      "pricing.enterprise.text":
        "投标响应管理、企业采购支持与投标运营。",
      "pricing.enterprise.price": "起价 $12k / 月",
      "pricing.enterprise.range": "常见区间 $18k - $40k",
      "pricing.blockchain.price": "起价 $18k / 评估",
      "pricing.blockchain.range": "常见区间 $25k - $60k",
      "pricing.gambling.title": "博彩 / 投注",
      "pricing.gambling.text":
        "受监管博彩运营、风险控制与合规交付。",
      "pricing.gambling.price": "起价 $14k / 月",
      "pricing.gambling.range": "常见区间 $22k - $50k",
      "pricing.legal.price": "起价 $9k / 月",
      "pricing.legal.range": "常见区间 $15k - $30k",
      "pricing.cta.eyebrow": "定制范围",
      "pricing.cta.title": "需要定制范围或多服务项目？",
      "pricing.cta.subtitle":
        "分享你的目标，我们将在 48 小时内给出执行团队方案。",
      "form.company": "公司名称",
      "form.companyPlaceholder": "Extender Inc.",
      "form.email": "邮箱",
      "form.emailPlaceholder": "name@company.com",
